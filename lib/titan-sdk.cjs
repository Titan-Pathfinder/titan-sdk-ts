...
(function (SwapVersion) {
    SwapVersion[SwapVersion["V2"] = 2] = "V2";
    SwapVersion[SwapVersion["V3"] = 3] = "V3";
})(SwapVersion || (SwapVersion = {}));

var v1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    get StreamDataType () { return StreamDataType; },
    get SwapVersion () { return SwapVersion; },
...
class GzipCompressor {
    ...
    compress(data) {
        return httpEncoding.gzip(data);
    }
    decompress(data) {
        return httpEncoding.gunzip(data);
    }
}
class BrotliCompressor {
    ...
    compress(data) {
        return httpEncoding.brotliCompress(data);
    }
    decompress(data) {
        return httpEncoding.brotliDecompress(data);
    }
}
class ZstdCompressor {
    ...
    compress(data) {
        return httpEncoding.zstdCompress(data);
    }
    decompress(data) {
        return httpEncoding.zstdDecompress(data);
    }
}
/**
